...
public class FastJsonUtils
{
    ...
    {
    	if(ParamsCheckUtils.isNull(jsonData)){
    		return null;
    	}
    ...
    /**
     * 功能描述：把JSON数据转换成hashmap集合key:string,value:string
     * @param jsonData
     * @return
     * @throws Exception
     */
    public static List<HashMap<String, String>> getBeanHashMapList(String jsonData) throws Exception
    {
        return JSON.parseObject(jsonData, new TypeReference<List<HashMap<String, String>>>()
        {
        });
    }
}
