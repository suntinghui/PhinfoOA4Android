...
public class MyRatingBar extends FrameLayout implements View.OnClickListener {
    private static final String TAG = MyRatingBar.class.getSimpleName();
...
//            } else {
                mFillDrawable = context.getResources().getDrawable(R.drawable.ratingbar_f);
                mEmptyDrawable = context.getResources().getDrawable(R.drawable.ratingbar_n);
//            }
        } else {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MyRatingBar);
            mMaxCount = typedArray.getInteger(R.styleable.MyRatingBar_rb_max_count, MAX_COUNT);
            mCount = typedArray.getInteger(R.styleable.MyRatingBar_rb_count, 0);
            mFillDrawable = typedArray.getDrawable(R.styleable.MyRatingBar_rb_fill);
            mEmptyDrawable = typedArray.getDrawable(R.styleable.MyRatingBar_rb_empty);
            mSpace = typedArray.getDimensionPixelSize(R.styleable.MyRatingBar_rb_space, 0);
            mClickRating = typedArray.getBoolean(R.styleable.MyRatingBar_rb_click_rating, true);
            mTouchRating = typedArray.getBoolean(R.styleable.MyRatingBar_rb_touch_rating, true);
            typedArray.recycle();
...
//                }
    ...
    public interface OnRatingChangeListener {
         ...
         */
        void onChange(MyRatingBar ratingBar, int preCount, int curCount);
    }
