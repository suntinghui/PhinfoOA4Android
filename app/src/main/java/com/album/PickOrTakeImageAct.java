 ...
 */
public class PickOrTakeImageAct extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
...
//    private TranslateAnimation reverseanimation;
    ...
    /** 选择图片的数量总数，默认为9 */
    private int picNums = Integer.MAX_VALUE;
    /** 当前选中的图片数量 */
    ...
    public static final String EXTRA_HAS_NUMS = "extra_has_nums";
        ...
        if (Build.VERSION.SDK_INT < 11){
            ...
            animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    rl_choose_directory.setAlpha(1 - Math.abs(value / CommonUtil.dip2px(PickOrTakeImageAct.this, 400)));
            ...
            reverseanimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    listView.setLayoutParams(params);
                    rl_choose_directory.setAlpha(1 - Math.abs(value / CommonUtil.dip2px(PickOrTakeImageAct.this, 400)));
                    if (value <= -CommonUtil.dip2px(PickOrTakeImageAct.this, 300)) {
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
    ...
    protected void initData() {
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (MyApplet.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4))/3;

        picNums = getIntent().getIntExtra(EXTRA_NUMS, 100);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Cursor cursor = contentResolver.query(uri, null, MediaStore.Images.Media.MIME_TYPE + "=\"image/jpeg\" or " +
                        MediaStore.Images.Media.MIME_TYPE + "=\"image/png\"", null, MediaStore.Images.Media.DATE_ADDED+" desc");
                if (cursor != null){
                    allImages.clear();
...
//    }
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.tv_choose_image_directory) {//                window.showAsDropDown(tv_choose_image_directory);
            ...
            if (currentPicNums > 0) {
                ...
                intent.setClass(PickOrTakeImageAct.this, PickBigImagesAct.class);
                intent.putExtra(PickBigImagesAct.EXTRA_DATA, getChoosePicFromList());
                intent.putExtra(PickBigImagesAct.EXTRA_ALL_PICK_DATA, picklist);
                intent.putExtra(PickBigImagesAct.EXTRA_CURRENT_PIC, 0);
                intent.putExtra(PickBigImagesAct.EXTRA_LAST_PIC, picNums - currentPicNums);
                intent.putExtra(PickBigImagesAct.EXTRA_TOTAL_PIC, picNums);
    ...
    private static class MyHandler extends Handler{
        ...
        WeakReference<PickOrTakeImageAct> activity = null;

        public MyHandler(PickOrTakeImageAct context){
            activity = new WeakReference<PickOrTakeImageAct>(context);
        }
    ...
    private class GridViewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (currentShowPosition == -1 && i==0){
                view = new ImageView(PickOrTakeImageAct.this);
            ...
            if (bitmap != null){
                ...
                holder.iv_content.setBackgroundResource(R.drawable.default_image_layer);
            }
            return view;
        }
    }
    ...
    private class ListviewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_directory_pic.setBackgroundResource(R.drawable.default_image_layer);
            }
            return view;
        }
    }
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.iv_content) {
                if (picNums > 1) {
                    ...
                    intent.putExtra(PickBigImagesAct.EXTRA_DATA, getAllImagesFromCurrentDirectory());
                    intent.putExtra(PickBigImagesAct.EXTRA_ALL_PICK_DATA, picklist);
                    intent.putExtra(PickBigImagesAct.EXTRA_CURRENT_PIC, position);
                    intent.putExtra(PickBigImagesAct.EXTRA_LAST_PIC, picNums - currentPicNums);
                    intent.putExtra(PickBigImagesAct.EXTRA_TOTAL_PIC, picNums);
                ...
                if (getImageDirectoryModelStateFromMapById(position)) {
                    if (currentPicNums == picNums) {
                        toggleImageDirectoryModelStateFromMapById(position);
                        Toast.makeText(PickOrTakeImageAct.this, String.format(getString(R.string.choose_pic_num_out_of_index), picNums), Toast.LENGTH_SHORT).show();
                        return;
                    }
                    picklist.add(getImageDirectoryModelUrlFromMapById(holder.position));
                    holder.iv_pick_or_not.setImageResource(R.drawable.image_choose);
