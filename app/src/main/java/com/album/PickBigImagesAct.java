 ...
 */
public class PickBigImagesAct extends Activity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = LayoutInflater.from(PickBigImagesAct.this).inflate(R.layout.widget_zoom_iamge, null);
            ...
            Bitmap bitmap = AlbumBitmapCacheHelper.getInstance().getBitmap(getPathFromList(position), 0, 0, new AlbumBitmapCacheHelper.ILoadImageCallback() {
                ...
                public void onLoadImageCallBack(Bitmap bitmap, String path, Object... objects) {
                    ...
                    if (view != null && bitmap != null)
                        ((ZoomImageView)viewPager.findViewWithTag(path)).setSourceImageBitmap(bitmap, PickBigImagesAct.this);
                }
            }, position);
            if (bitmap != null){
                zoomImageView.setSourceImageBitmap(bitmap, PickBigImagesAct.this);
            }
