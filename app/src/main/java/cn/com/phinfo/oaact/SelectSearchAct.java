...
import cn.com.phinfo.protocol.SelectSearchRun;
...
public class SelectSearchAct extends SearchBaseAct implements OnItemClickListener {
	...
	protected void onRefresh() {
		this.quickHttpRequest(ID_LIST, new SelectSearchRun(queryEdit.getText().toString().trim(), page));
	}
